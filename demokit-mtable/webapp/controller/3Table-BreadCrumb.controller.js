sap.ui.define([
	...
	'sap/m/MessageToast',
	'sap/m/Text',
	'com/sap/demokitmtable/util/Formatter',
	'sap/ui/core/Fragment',
], (Controller, JSONModel, Label, Link, MessageToast, Text, Formatter,Fragment ) => {
    "use strict";
    return Controller.extend("com.sap.demokitmtable.controller.3Table-BreadCrumb", {
        ...
        onInit() {
			...
			var sPath = sap.ui.require.toUrl("com/sap/demokitmtable/model/productHierarchy.json");
			...
			if (!this._pTemplate) {
				this._pTemplate = Fragment.load({
					...
					name: "com.sap.demokitmtable.fragments.Row"
				});
			}
			this._oTable = this.byId("idBreadCrumbTable");
